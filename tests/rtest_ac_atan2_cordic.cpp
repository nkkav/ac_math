...
void test_ac_atan2_cordic(
  const    ac_fixed<Wfi, Ifi, Sfi, AC_TRN, AC_WRAP>          &y,
...
int test_driver(
  double &cummulative_max_error_atan2,
...
)
{
  ...
  if (max_error_atan2>cummulative_max_error_atan2) { cummulative_max_error_atan2 = max_error_atan2; }
